...
class AnnuityBuyoutForm extends React.Component {
    static contextTypes = {
...
export default AnnuityBuyoutForm = reduxForm({
    form: 'AnnuityBuyoutForm'
})(AnnuityBuyoutForm);

const selector = formValueSelector('AnnuityBuyoutForm');