...
class GoldPrice extends React.Component {
    static contextTypes = {
    ...
    onPrint = () => {
        let query = {
            ...
            reportQuery: {
                ...
                queryPrice: this.state.queryPrice || 0
            }
        };
    ...
    render = () => (
        <div style={{margin:20}}>
            ...
            <div className="row form-group">
                ...
                <div className="col-sm-4">
                    <input type="number" min="0" max="100000" className="form-control" onChange={e => {
                        this.setState({
                            queryPrice: e.target.value
                        });
                    }} value={this.state.queryPrice} />
                </div>
            </div>
            <div className="row form-group">
