...
import { list as listLoad, remove as removeItem } from '../../actions/goods';
...
class Goods extends React.Component {
                ...
                <Column actions={true} template={
                    row =>
                        <ButtonGroup bsSize="xs">
                            <Button onClick={e => this.context.router.push(`/goods/${row.id}`)}><Glyphicon glyph="edit"/> Изменить</Button>
                            <Restrict permissions={permissions.GoodsManage}>
                                <Button onClick={e => {
    ...
    renderActions = () =>
        <ButtonGroup bsSize="sm">
            <Restrict permissions={permissions.GoodsManage}>
                <Button onClick={e => this.context.router.push('/goods/0')}><Glyphicon glyph="plus"/> Создать</Button>
            </Restrict>
        </ButtonGroup>
}
