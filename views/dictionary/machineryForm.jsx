...
import { marks, models, colors } from '../../actions/machineries';

class MachineryForm extends React.Component {
    render = () => {
...
export const selector = formValueSelector('MachineryForm');
export const submitForm = dispatch => dispatch(submit('MachineryForm'));