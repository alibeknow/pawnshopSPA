...
import { list as listLoad, remove as removeItem } from '../../actions/purities';
...
class Purities extends React.Component {
                ...
                <Column actions={true} template={
                    row =>
                        <ButtonGroup bsSize="xs">
                            <Button onClick={e => this.context.router.push(`/purities/${row.id}`)}><Glyphicon glyph="edit"/> Изменить</Button>
                            <Restrict permissions={permissions.PurityManage}>
                                <Button onClick={e => {
    ...
    renderActions = () =>
        <ButtonGroup bsSize="sm">
            <Restrict permissions={permissions.PurityManage}>
                <Button onClick={e => this.context.router.push('/purities/0')}><Glyphicon glyph="plus"/> Создать</Button>
            </Restrict>
        </ButtonGroup>
}
