...
import { card as cardLoad, save as cardSave } from '../../actions/goods';
...
class GoodsCard extends React.Component {
        ...
        this.props
            ...
            .then(action => {
                if (action && action.data) {
                    this.context.router.push(`/goods/${action.data.id}`);
                }
            });
    ...
    render = () => {
        ...
        return (
            <div>
                <Restrict permissions={permissions.GoodsManage} pass>
