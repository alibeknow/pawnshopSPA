...
import { list as listLoad, remove as removeItem } from '../../actions/cars';
...
class Cars extends React.Component {
                ...
                <Column actions={true} template={
                    row =>
                        <ButtonGroup bsSize="xs">
                            <Button onClick={e => this.context.router.push(`/cars/${row.id}`)}><Glyphicon glyph="edit"/> Изменить</Button>
    ...
    renderActions = () =>
        <ButtonGroup bsSize="sm">
            <Restrict permissions={permissions.CarManage}>
                <Button onClick={e => this.context.router.push('/cars/0')}><Glyphicon glyph="plus"/> Создать</Button>
            </Restrict>
        </ButtonGroup>
}
